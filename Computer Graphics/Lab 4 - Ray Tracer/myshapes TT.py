...
# def cast_ray(origin, direction, objects):
#     t_min = float('inf')
#     closest_obj = None
...
#             t_min, closest_obj = cast_ray(camera['LookFrom'], ray_direction, objects)

#             if closest_obj is None:
#                 # No intersection, set pixel color to background color
#                 image[y, x] = light['BackgroundColor']
#             else:
#                 # Intersection with an object, set pixel color to diffuse color of the object
#                 image[y, x] = closest_obj.Mdiff
